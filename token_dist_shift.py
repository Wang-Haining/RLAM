...
def generate_output(model: AutoModelForCausalLM,
                    base_model: str,
...
def analyze_token_distribution_shift(base_model: str,
    ...
    token_shifts = []
    for t in range(1, len(ppo_tokens)):
        ...
        shift_category = 'unshifted' if sft_rank == 0 else 'marginal' if 1 <= sft_rank <= 2 else 'shifted'
